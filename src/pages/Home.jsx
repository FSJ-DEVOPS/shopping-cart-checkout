      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4 font-raleway">Featured Products</h2>
            <p className="text-gray-600 font-raleway">Discover our most popular items</p>
          </div><Link
              to="/shop"
              >
